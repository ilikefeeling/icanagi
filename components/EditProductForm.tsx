...
import { Save, DollarSign, ExternalLink, Code } from 'lucide-react'
...
export function EditProductForm({ product }: EditProductFormProps) {
    ...
    const {
        ...
        defaultValues: {
            ...
            apiEndpoint: product.apiEndpoint || undefined,
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            {/* SEO 정보 */}
            <div className="bg-slate-900/50 rounded-xl p-6 border border-slate-800">
                <h2 className="text-xl font-bold text-white mb-4">SEO 메타데이터</h2>
                ...
                <div className="flex flex-col gap-3">
                    <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        <div>
                            ...
                            <div className="text-sm text-gray-400">공개하지 않음</div>
                        </div>
                    </label>
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        />
                        <div>
                            <div className="font-medium text-white">공개</div>
                            <div className="text-sm text-gray-400">메인 페이지에 표시</div>
                        </div>
                    </label>
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        />
                        <div>
                            <div className="font-medium text-white">보관됨</div>
                            <div className="text-sm text-gray-400">숨김 (삭제하지 않음)</div>
                        </div>
                    </label>
                </div>
            </div>
